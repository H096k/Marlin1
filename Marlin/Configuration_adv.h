...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define EVENT_GCODE_SD_ABORT "G1 X0 Y300 Z+10\nM18 X Y E"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_XY .025       // (steps or mm) Steps or millimeter distance for each XY babystep
...
#define ADVANCED_PAUSE_FEATURE
  ...
  //#define ADVANCED_PAUSE_RESUME_PRIME          0.25  // (mm) Extra distance to prime nozzle after returning from park.
